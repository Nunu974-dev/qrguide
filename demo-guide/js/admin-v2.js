...
// === MODIFIER UN GUIDE (ouverture dans nouvel onglet) ===
async function editGuide(guideId) {
    // Ouvrir le formulaire complet dans un nouvel onglet
    window.open(`/mon-compte.html?editGuide=${guideId}`, '_blank');
}

// ANCIEN CODE DU MODAL SUPPRIMÉ - On utilise maintenant l'interface client complète
